...
const PRINTER_TONER_FALLBACKS = {
  '192.168.1.10': { black: 47, cyan: 91, magenta: 13, yellow: 75 },  // Printer_A
  '192.168.1.11': { black: 35, cyan: 78, magenta: 62, yellow: 45 },  // Printer_B
  '192.168.1.12': { black: 22, cyan: 56, magenta: 89, yellow: 33 },  // Printer_C
  '192.168.1.13': { black: 55, cyan: 40, magenta: 75, yellow: 60 }   // Printer_D
};
