...
class PrintServerMonitoringService {
  ...
  saveServers() {
    try {
      ...
      fs.writeFileSync(SERVERS_FILE, JSON.stringify(this.servers, null, 2), 'utf8');
    } catch (error) {
      console.error('[PrintServer] Error saving servers:', error.message);
    }
  }
  ...
  saveHistory() {
    try {
      ...
      console.error('[PrintServer] Error saving history:', error.message);
    }
  }
  ...
  saveLogs() {
    try {
      ...
      console.error('[PrintServer] Error saving logs:', error.message);
    }
  }
  ...
  startMonitoring() {
    ...
    console.log('[PrintServer] Starting monitoring (30s interval)');
    // Run immediately
